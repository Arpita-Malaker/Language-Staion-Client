...
const ManageUser = () => {
  ...
  const handleAdmin = user => {
    ...
    fetch(`https://b7a12-summer-camp-server-side-arpita-malaker.vercel.app/users/admin/${user._id}`, {
      method: 'PATCH'
    })
      .then(res => res.json())
      .then(data => {
  ...
  const handleInstructor = user => {
    ...
    fetch(`https://b7a12-summer-camp-server-side-arpita-malaker.vercel.app/users/instructor/${user._id}`, {
      method: 'PATCH'
    })
      .then(res => res.json())
      .then(data => {
